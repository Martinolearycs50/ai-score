...
export const metadata: Metadata = {
  ...
  description:
    "Analyze your website's AI search visibility with our free tool. Get actionable insights to improve your ranking in ChatGPT, Claude, Perplexity, and other AI search engines.",
