...
describe('PillarScoreDisplay Component', () => {
  ...
  it('should have proper accessibility attributes', () => {
    ...
    expect(progressBars[0]).toHaveAttribute('aria-valuenow', '100'); // 25/25 * 100
    expect(progressBars[1]).toHaveAttribute('aria-valuenow', '80'); // 20/25 * 100
    expect(progressBars[2]).toHaveAttribute('aria-valuenow', '38'); // 15/40 * 100
    expect(progressBars[3]).toHaveAttribute('aria-valuenow', '50'); // 10/20 * 100
