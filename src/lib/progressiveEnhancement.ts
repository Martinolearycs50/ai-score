...
function generateQuickRecommendations(scores: any, pageType: string): any[] {
  ...
  if (scores.retrieval < 20) {
    recommendations.push({
      ...
      description:
        'Your site may be loading slowly. Consider optimizing images and enabling caching.',
      impact: 'High',
    });
  }
  ...
  if (scores.factDensity < 10) {
    recommendations.push({
      ...
      description:
        'Consider adding more detailed information, statistics, or examples to your content.',
      impact: 'Medium',
    });
  }
