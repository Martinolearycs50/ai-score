...
interface BusinessPersona {
  ...
  narratives: {
    recognition: string; // Initial recognition message
    curiosityGap: string; // Teaser that creates anticipation
    concernTrigger: string; // Loss aversion activation
    hopeTrigger: string; // Positive possibility
    celebrationMessage: string; // Success message
  };
  recommendations: {
    priorities: string[]; // Which scoring pillars matter most
    quickWins: string[]; // Easy improvements with big impact
    specificTips: string[]; // Persona-specific advice
  };
}

export const businessPersonas: Record<ExtractedContent['businessType'], BusinessPersona> = {
  payment: {
    type: 'payment',
    ...
    characteristics: {
      ...
      typicalCompetitors: ['Stripe', 'PayPal', 'Square', 'Adyen', 'Braintree'],
    },
    narratives: {
      recognition:
        "Analyzing your payment platform... We see you're competing in the financial technology space.",
      curiosityGap:
        "Wait... we're seeing something interesting about how AI recommends payment solutions...",
      concernTrigger:
        "While you focused on features, {competitor} is getting recommended by AI for '{searchQuery}'",
      hopeTrigger:
    ...
    recommendations: {
      priorities: ['TRUST', 'STRUCTURE', 'FACT_DENSITY'],
      quickWins: [
      ...
      specificTips: [
        'AI tools prioritize payment platforms that clearly state compliance (PCI-DSS, SOC2)',
  ...
  ecommerce: {
    ...
    characteristics: {
      ...
      painPoints: [
        'Competition from Amazon and large retailers',
      ...
      typicalCompetitors: ['Amazon', 'Shopify stores', 'Etsy sellers', 'Brand-specific stores'],
    },
    narratives: {
      recognition:
        "Analyzing your e-commerce store... We see you're selling {mainProduct} to {targetAudience}.",
      curiosityGap:
        "Interesting... AI shopping assistants are recommending your competitors for '{productCategory}'...",
      concernTrigger:
        "You're losing an estimated {visitorCount} AI-driven shoppers daily to {competitor}",
      hopeTrigger:
        'But with just 3 specific changes, you could capture those shoppers looking for {productType}',
      celebrationMessage: 'Your products are now AI-optimized for discovery!',
    },
    recommendations: {
      priorities: ['STRUCTURE', 'FACT_DENSITY', 'TRUST'],
      quickWins: [
        'Add detailed product specifications in lists',
      ...
      specificTips: [
        'AI favors stores with complete product data (materials, dimensions, origin)',
  ...
  blog: {
    ...
    characteristics: {
      ...
      painPoints: [
        'Content gets buried in search results',
    ...
    narratives: {
      recognition:
        "Analyzing your blog about {primaryTopic}... We see you're creating content for {targetAudience}.",
      curiosityGap:
        "We noticed something... When people ask AI about '{topicArea}', they're getting different blogs...",
      concernTrigger:
        'Your valuable insights on {topic} are invisible to AI, while {competitor} dominates AI responses',
      hopeTrigger:
        'The good news? Blogs that implement our content optimization see AI citations within 48 hours',
      celebrationMessage: 'Your expertise is now AI-discoverable!',
    },
    recommendations: {
      priorities: ['RECENCY', 'TRUST', 'FACT_DENSITY'],
      quickWins: [
      ...
      specificTips: [
        'AI prioritizes blogs with clear expertise signals',
  ...
  news: {
    ...
    characteristics: {
      ...
      aiSearchNeeds: [
        'Clear datelines and timestamps',
        'Author credentials',
        'Source attribution',
        'Fact-checking indicators',
      ],
      typicalCompetitors: ['CNN', 'BBC', 'Reuters', 'Local news outlets', 'Industry publications'],
    },
    narratives: {
      recognition:
        'Analyzing your news publication... We see you cover {primaryTopic} with a focus on {location}.',
      curiosityGap:
        "Curious finding... When AI summarizes news about '{newsCategory}', certain outlets dominate...",
      concernTrigger:
        "Breaking: Your news stories aren't being cited by AI, giving {competitor} the narrative control",
      hopeTrigger:
        'But news sites with proper AI optimization see 5x more citations in AI summaries',
      celebrationMessage: 'Your journalism is now AI-citation ready!',
    },
    recommendations: {
      priorities: ['RECENCY', 'TRUST', 'STRUCTURE'],
      quickWins: [
        'Add clear datelines to all articles',
        'Include journalist bylines with credentials',
        'Create fact-check badges',
        'Add "Key Points" summaries',
      ],
      specificTips: [
        'AI favors news with clear sourcing and attribution',
  ...
  documentation: {
    ...
    characteristics: {
      primaryGoals: [
        'Help developers integrate quickly',
    ...
    narratives: {
      recognition:
        "Analyzing your developer documentation for {mainProduct}... We see you're helping developers with {mainService}.",
      curiosityGap:
        "Interesting pattern detected... Developers are asking AI about '{apiFeature}' but getting competitor docs...",
      concernTrigger:
        'Your API docs are invisible to AI coding assistants, sending developers to {competitor} instead',
    ...
    recommendations: {
      priorities: ['STRUCTURE', 'FACT_DENSITY', 'RECENCY'],
      quickWins: [
      ...
      specificTips: [
        'AI coding assistants favor docs with complete examples',
  ...
  corporate: {
    ...
    characteristics: {
      ...
      typicalCompetitors: ['Industry leaders', 'Consulting firms', 'Service providers', 'Agencies'],
    },
    narratives: {
      recognition:
        "Analyzing {companyName}... We see you're a {industry} company serving {targetAudience}.",
      curiosityGap:
        "We discovered something... When executives ask AI about '{serviceType}', they're getting your competitors...",
      concernTrigger:
        'Potential clients asking AI for {industry} solutions are being directed to {competitor}, not you',
    ...
    recommendations: {
      priorities: ['TRUST', 'FACT_DENSITY', 'STRUCTURE'],
      quickWins: [
        'Add specific client success metrics',
        'Include industry awards and certifications',
        'Create detailed service pages',
        'Add team member credentials',
      ],
      specificTips: [
        'AI favors companies with quantifiable achievements',
  ...
  educational: {
    ...
    characteristics: {
      ...
      typicalCompetitors: ['Coursera', 'Udemy', 'University programs', 'YouTube tutorials'],
    },
    narratives: {
      recognition:
        'Analyzing your educational platform... We see you teach {primaryTopic} to {targetAudience}.',
      curiosityGap:
        "Surprising discovery... When learners ask AI about '{skillArea}', they're directed elsewhere...",
      concernTrigger:
        'Students seeking {courseType} training are being sent to {competitor} by AI assistants',
  ...
  other: {
    ...
    characteristics: {
      ...
      typicalCompetitors: ['Similar businesses', 'Industry alternatives', 'Local competitors'],
    },
    narratives: {
      ...
      hopeTrigger:
        'Businesses that optimize these signals see immediate AI visibility improvements',
      celebrationMessage: 'Your business is now AI-optimized!',
    },
    recommendations: {
      priorities: ['STRUCTURE', 'TRUST', 'FACT_DENSITY'],
      quickWins: [
      ...
      specificTips: [
        'AI needs clear understanding of what you offer',
...
export function personalizeNarrative(
  ...
  const replacements: Record<string, string | number> = {
    ...
    mainProduct:
      extractedContent.businessAttributes.mainProduct ||
      extractedContent.productNames[0] ||
      'your product',
 ...
 */
export function getPriorityImprovements(
  businessType: ExtractedContent['businessType'],
  currentScore: number
): string[] {
  ...
  if (currentScore < 40) {
    ...
    // For high scores, focus on maintaining and fine-tuning
    return [
