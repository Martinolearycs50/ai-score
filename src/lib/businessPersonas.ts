...
concernTrigger: "While you focused on features, {
competitor};
 is getting recommended by AI for '{
searchQuery}
'",
hopeTrigger: "But here's the opportunity: Payment platforms that emphasize {
missingElement};
 see 3x more AI recommendations",
...
specificTips: [ 'AI favors stores with complete product data (materials, dimensions, origin)',
...
// Replace with actual business attributes const replacements: Record<string,
  string | number> = {
...
location: extractedContent.businessAttributes.location || 'your area', ...additionalData
};
